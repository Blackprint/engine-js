...
// node --no-warnings --enable-source-maps --loader ../es6-https-loader.mjs ./init.mjs
// node --no-warnings --enable-source-maps --loader @blackprint/engine/es6-https-loader ./init.mjs
